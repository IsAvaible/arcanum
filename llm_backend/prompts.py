"""
This file includes all system prompts used in the project
"""
...
If CONTEXT contains TRANSCRIPTION DATA FROM AUDIO FILES:  
...
IF CONTEXT CONTAINS A PDF FILE WITH TIMESTAMPS DO NOT GIVE OUT TIMESTAMPS FOR TEXT FILES, ONLY AUDIO!
...
7. **Product Names and Model number**: Identify product names, model numbers, names of companies or organizations
8. **Symbols and Stickers**: Note any visible symbols, stickers, or labels on the machine. Describe their meaning and relevance.
9. **Colors and Buttons**: Pay close attention to the colors, shapes, and positions of buttons, levers, or other control elements. Explain their possible functions and their role in solving the problem.
10. **Interaction**: Observe how individuals or tools interact with the machine. List the steps taken and explain their purpose.
