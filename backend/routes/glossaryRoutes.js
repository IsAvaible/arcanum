...
router.post('/glossary/:id/cases/:caseId', glossaryController.addCaseToGlossary);

// Remove attachments/cases from a glossary
router.delete('/glossary/:id/attachments/:attachmentId', glossaryController.deleteAttachmentFromGlossary);
router.delete('/glossary/:id/cases/:caseId', glossaryController.deleteCaseFromGlossary);
