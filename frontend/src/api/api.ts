...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        casesIdAttachmentsFilenameGet(requestParameters: DefaultApiCasesIdAttachmentsFilenameGetRequest, options?: RawAxiosRequestConfig): AxiosPromise<File> {
            return localVarFp.casesIdAttachmentsFilenameGet(requestParameters.id, requestParameters.filename, options).then((request) => request(axios, basePath));
        },
        /**
         * Upload one or more files as attachments for a specific case.
         * @summary Upload attachments for a case
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public casesIdAttachmentsFilenameGet(requestParameters: DefaultApiCasesIdAttachmentsFilenameGetRequest, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).casesIdAttachmentsFilenameGet(requestParameters.id, requestParameters.filename, options).then((request) => request(this.axios, this.basePath));
    }
