...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    casesIdAttachmentsFilenameDelete: async (
      id: number,
      filename: string,
    ...
    casesIdPut: async (
      ...
      solution?: string,
      assignee?: string,
      status?: CasesIdPutStatusEnum,
      caseType?: CasesIdPutCaseTypeEnum,
      priority?: CasesIdPutPriorityEnum,
      files?: Array<File>,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async casesIdAttachmentsFilenameDelete(
      id: number,
      filename: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.casesIdAttachmentsFilenameDelete(
        id,
        filename,
        options,
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['DefaultApi.casesIdAttachmentsFilenameDelete']?.[
...
export const DefaultApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    casesIdAttachmentsFilenameDelete(
      requestParameters: DefaultApiCasesIdAttachmentsFilenameDeleteRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .casesIdAttachmentsFilenameDelete(requestParameters.id, requestParameters.filename, options)
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public casesIdAttachmentsFilenameDelete(
    requestParameters: DefaultApiCasesIdAttachmentsFilenameDeleteRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return DefaultApiFp(this.configuration)
...
export type CasesIdPutCaseTypeEnum =
  (typeof CasesIdPutCaseTypeEnum)[keyof typeof CasesIdPutCaseTypeEnum]
/**
 * @export
 */
...
export type CasesIdPutPriorityEnum =
  (typeof CasesIdPutPriorityEnum)[keyof typeof CasesIdPutPriorityEnum]
/**
 * @export
 */
