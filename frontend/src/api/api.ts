...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
      ...
      getUsers: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
        const localVarPath = `/users`; // Endpunkt für Benutzer
        const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
        let baseOptions;
        if (configuration) {
          baseOptions = configuration.baseOptions;
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
      ...
      // Dummy-User
      async getUsers(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<{ name: string; image: string }>>> {
...
export class DefaultApi extends BaseAPI {
  ...
  public getUsers(options?: RawAxiosRequestConfig): AxiosPromise<Array<{ name: string; image: string }>> {
