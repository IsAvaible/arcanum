...
<template>
  <div class="relative">
    ...
    <div
      v-if="axis === 'vertical'"
      :class="[
        'absolute top-0 left-0 w-full h-10 bg-gradient-to-b from-white to-transparent pointer-events-none transition-opacity',
    ...
    <div
      v-if="axis === 'vertical'"
      :class="[
        'absolute bottom-0 left-0 w-full h-10 bg-gradient-to-t from-white to-transparent pointer-events-none transition-opacity',
